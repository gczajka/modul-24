...
public class Watcher {
    ...
    public void logFacadeEventsBeforeRunningMethods() {
        LOGGER.info("Method processOrder() was started");
    }

    @After("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))")
    public void logFacadeEventsEventAfterRunningMethods() {
        LOGGER.info("Method processOrder() was completed");
    }
